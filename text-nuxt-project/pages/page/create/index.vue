                    ...
                    <form @submit.prevent="submitData" enctype="multipart/form-data">
                        <div class="relative flex flex-grow">
                            ...
                            <div class="w-2/12  h-[80vh] relative overflow-auto bg-white">
                                <div class=" w-2/12  h-[80vh] overflow-auto flex-grow w-[13.49%] z-10 cursor-pointer bg-white fixed">
                                    <!-- status -->

                                    <div class="flex flex-col gap-1">
                                        <div @click="active = 1"
                                            :class="`${active == 1 ? 'border-l-4 border-l-red-600 bg-gray-100' : ''}`"
                                            class="w-full border-b border-t py-1 text-left pl-3 mt-3 text-sm hover:bg-gray-100">
                                            Status
                                        </div>

                                        <div
                                            :class="{ 'w-full border-b py-1 text-left pl-3 text-sm flex-col': true, 'flex': active == 1, 'hidden': active != 1 }">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        <div @click="active = 2"
                                            :class="`${active == 2 ? 'border-l-4 border-l-red-600 bg-gray-100' : ''}`"
                                            class="w-full border-b border-t py-1 text-left pl-3 mt-3 text-sm hover:bg-gray-100">
                                            Layout
                                        </div>

                                        <div
                                            :class="{ 'w-full border-b py-1 text-left pl-3 text-sm flex-col': true, 'flex': active == 2, 'hidden': active != 2 }">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        <div @click="active = 3"
                                            :class="`${active == 3 ? 'border-l-4 border-l-red-600 bg-gray-100' : ''}`"
                                            class="w-full border-b border-t py-1 text-left pl-3 mt-3 text-sm hover:bg-gray-100">
                                            Extra Props
                                        </div>

                                        <div
                                            :class="{ 'w-full border-b py-1 text-left pl-3 text-sm flex-col': true, 'flex': active == 3, 'hidden': active != 3 }">
                                            <div class="grid grid-col gap-2 mt-2">
                                                <Fieldset legend="Extra Props" :pt="{
                                                    ...
                                                    <div class="flex flex-col gap-2 w-full px-1 py-1"
