        ...
        <div class="w-full px-3 mt-1">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(product, index) in products.data" class="bg-white odd:bg-gray-100" :key="product.id">
                                ...
                                <td class="p-1 text-center text-xs">
                                    ...
                                    (((products.total) - ((products.current_page-1)*products.per_page))-index) 
                                    
                                    : ((products.total) - index) }}
                                </td>
                                <td class="p-1 text-left text-xs">
                                    <img class="h-8" :src="product.icon_small"/>
                                </td>
                                <td class="p-1 text-left text-xs">
                                ...
                                <td class="p-1 text-center text-xs flex">
                                    <div class="rounded-s-sm bg-blue-600 px-2 py-1 mt-1 text-white" title="Additional Product">
                                        <NuxtLink :to="`/product/additional/${product.id}`">
                                            <Icon name="fa6-solid:clone" width="1em" height="1em" />
                                        </NuxtLink>
                                    </div>
            ...
            <Sidebar v-model:visible="visibleRight" header="Product Filter" position="right">
                ...
                <div class="w-full mt-2">
                    ...
                    <select name="status" id="commission_type"
                        class="w-full text-sm border py-1 px-2 outline-none focus:border-red-200 rounded-md">
                ...
                <div class="w-full mt-2">
                    ...
                    <div>
                        <Calendar :pt="{
                            ...
                            }" class="w-[48%] mr-1 text-sm outline-none focus:border-red-200 rounded-md" v-model="startDate"
                                                    placeholder="Start Date" />
                                                <Calendar :pt="{
                                input: {
                                    class: 'px-4 py-1 border',
                                },
                            }" class="w-1/2 text-sm outline-none focus:border-red-200 rounded-md" v-model="endDate"
                ...
                <div class="w-full grid grid-cols-2 gap-2 mt-2">
                    ...
                    <div>
                        ...
                        <Dropdown v-model="selectedColor" :options="colors" optionLabel="name" placeholder="Select Size"
                            class="" />
                    </div>
                    <div></div>
                </div>
                ...
                <div class="w-full grid grid-cols-2 gap-2 mt-2">
                    <div>
                        ...
                        <Dropdown v-model="selectedSize" :options="sizes" filter optionLabel="name"
                    ...
                    <div>
                        ...
                        <Dropdown v-model="selectedColor" :options="colors" filter optionLabel="name"
                            placeholder="Select a Country" class="w-full md:w-14rem">
                            <template #value="slotProps">
                                <div v-if="slotProps.value" class="flex align-items-center">
                                    <img :alt="slotProps.value.label"
