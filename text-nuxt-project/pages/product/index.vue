            ...
            >
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="p-1 text-center text-xs">
                                    ...
                                    (((products.total) -
                                    ((products.current_page-1)*products.per_page))-index)
                                    : ((products.total) - index) }}
                                </td>
                                <td class="p-1 text-left text-xs">
                                    <img
                                        class="h-8"
                                        :src="product.icon_small"
                                    />
                                </td>
                                <td class="p-1 text-left text-xs">
                                ...
                                <td class="p-1 text-left text-xs">
                                    ...
                                    >
                                        {{ category.name }}
                                        <span
                                            v-if="product?.categories.length > (index+1)"
                                            >,
                                        </span>
                                    </span>
                                </td>
                                ...
                                <td class="p-1 text-center text-xs flex">
                                    ...
                                    <NuxtLink
                                        ...
                                        class="bg-yellow-500 px-2 py-1 mt-1 text-white"
                                        title="Edit"
                                    >
                                        <Icon
                                            name="subway:pencil"
                ...
                <div class="order_title text-sm flex justify-between h-full">
                    ...
                    <div class="flex -mt-1 h-dvh">
                        <a
                            v-for="(page, index) in products?.links"
                            :key="index"
            ...
            >
                ...
                <div class="w-full grid grid-cols-2 gap-2 mt-2">
                    ...
                    <div class="w-full mt-2">
                        ...
                        <MultiSelect
                            ...
                            class="w-full md:w-14rem h-11 flex items-center border border-gray-300"
                        >
                        </MultiSelect>
                    </div>
                    <!-- Size Filter -->
                    <div class="w-full mt-2">
                        <label for="color-filter" class="text-sm w-full"
                            >Size</label
                        >
                        <Dropdown
                ...
                <div class="mt-2 text-sm text-gray-600">
                    <span v-if="totalProducts"
                        >Showing {{ totalProducts }} results</span
                    >
